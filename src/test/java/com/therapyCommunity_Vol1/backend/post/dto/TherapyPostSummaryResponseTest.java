...
class TherapyPostSummaryResponseTest {
    ...
    void PRIVATE_게시글은_canViewPrivate_false면_accessLocked_true_본문_마스킹() {
        ...
        TherapyPostSummaryResponse r = TherapyPostSummaryResponse.from(post, 0L, 0L, false, false, null, java.util.List.of());
    ...
    void PRIVATE_게시글은_canViewPrivate_true면_accessLocked_false_본문_정상_노출() {
        ...
        TherapyPostSummaryResponse r = TherapyPostSummaryResponse.from(post, 0L, 0L, false, true, null, java.util.List.of());
    ...
    void PUBLIC_게시글은_canViewPrivate과_무관하게_accessLocked_false() {
        ...
        TherapyPostSummaryResponse rUser = TherapyPostSummaryResponse.from(post, 0L, 0L, false, false, null, java.util.List.of());
        TherapyPostSummaryResponse rTherapist = TherapyPostSummaryResponse.from(post, 0L, 0L, false, true, null, java.util.List.of());

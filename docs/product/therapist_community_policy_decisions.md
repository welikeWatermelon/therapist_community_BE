...
- 기능명세서: [therapist_community_feature_spec.csv](./therapist_community_feature_spec.csv)
- 요구사항명세서: [therapist_community_requirements_spec.csv](./therapist_community_requirements_spec.csv)
